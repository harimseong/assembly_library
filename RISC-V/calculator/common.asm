# -------------------------------------------------------------------
# [Computer Architecture] Test code for the 1st project (calculator)
# -------------------------------------------------------------------
...
test_core:
	...
	la s1, int_input1			#store the base address array input1 in x6
	la s2, int_input2			#store the base address array input1 in x7
...
test:
	...
	addi a1, zero, 0				#test addition
	jal ra, test_core
	addi a1, zero, 1				#test subtraction
	jal ra, test_core
	addi a1, zero, 2				#test multiplication
	jal ra, test_core
	addi a1, zero, 3				#test division
	jal ra, test_core
